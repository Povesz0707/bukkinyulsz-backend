package com.example.bukkinyulszbackend.util;

public class AppConstant {
    public static final String URI_API = "api";
    public static final String URI_API_LIST = "list";
    public static final String URI_API_GET = "get";
    public static final String URI_API_GET_BY = "getBy";
